...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('addoptprice_core_path', null,
                    $modx->getOption('core_path') . 'components/addoptprice/') . 'model/';
            $modx->addPackage('addoptprice', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/addoptprice/model/schema/addoptprice.mysql.schema.xml';
